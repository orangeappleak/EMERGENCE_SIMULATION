import type { AuthorityCheck, AuthorityEvent, Building, Citizen, CitizenIntention, ConversationClassification, ConversationEntry, ConversationTopic, DailyActivity, FamilyRole, Household, LifeStage, SimulationSnapshot, SimulationState, WeatherState } from "../types/simulation";
import {
...
import { buildingById, buildingContains, homeStartSlot, isAtDestination, moveCitizen, placeSlotById, setDestination } from "./movementSystem";
