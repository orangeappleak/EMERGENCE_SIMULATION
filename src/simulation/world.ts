import type { AuthorityCheck, AuthorityEvent, Building, Citizen, CitizenIntention, ConversationClassification, ConversationEntry, ConversationTopic, DailyActivity, FamilyRole, Household, LifeStage, PlaceSlot, RoutePoint, SimulationSnapshot, SimulationState, WeatherState } from "../types/simulation";
import {
